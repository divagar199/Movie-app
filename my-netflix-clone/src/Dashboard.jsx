  ...
  return (
    <div className="bg-[#111] min-h-screen text-white overflow-hidden">
      ...
      >
        ...
        <div className="relative ml-4 md:ml-12 pt-[20vh] md:pt-[30vh] h-[190px] z-10">
          ...
          <h1 className="w-full md:w-[45rem] leading-[1.3] pt-4 text-sm md:text-lg max-w-[500px] drop-shadow-md">
